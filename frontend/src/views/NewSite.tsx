    ...
    <div>
        ...
        <div className="banner info" style={{ marginBottom: 14 }}>
          <div className="spread">
            <p className="small" style={{ margin: 0, maxWidth: 420 }}>
              Not sure what to build or which folder to hand over? Copy this prompt into ChatGPT,
              Claude or whatever AI you already use, add one line about your website, and it will
              tell you exactly what to do here.
            </p>
            <button
      ...
      {!updating && (
        <>
          ...
          <p className="hint" style={{ marginTop: -4, marginBottom: 14 }}>
            Pick the one that matches your project — like the choice below, it&rsquo;s set when the
            website is made and can&rsquo;t be changed afterwards.
          </p>
        </>
      )}
      ...
      {!updating && (
        <>
          ...
          {!serverRendered && (
            <p className="hint" style={{ marginTop: -4, marginBottom: 14 }}>
              Pick either one — but pick it now: a website is connected to GitHub or fed by hand for as
              long as it exists, and it can&rsquo;t be swapped over afterwards.
            </p>
          )}
        </>
      )}
