  ...
  return (
    <div className="stack">
        ...
        {where && (
          <>
            ...
            <p className="hint" style={{ margin: 0 }}>
              GitHub will ask which repositories AWS may read — pick the one you're putting online (or all
              of them, if you prefer). Then come back here.
              {where.region ? ` This is the app for ${where.region}, the region your account is connected to.` : ""}
            </p>
          </>
        )}
      </div>
      ...
      <div className="card stack">
        ...
        <p className="small muted" style={{ margin: 0 }}>
          This one-time key is what lets AWS set the automatic deploy up on your repository. It goes
          straight to your own AWS account — HostingPoppy never stores it, and it's wiped from this screen
