// The wire contract between the backend and the frontend. The frontend keeps its own
// copy (frontend/src/types.ts) because the two are separate builds — keep them in step.
